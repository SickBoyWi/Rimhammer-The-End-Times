...
{
    public class QuestNode_GetSiteTileFlatHills : QuestNode
    {
        [NoTranslate]
        ...
        private bool TryFindTile(Slate slate, out int tile)
        {
            ...
            return QuestNode_GetSiteTileFlatHills.TryFindNewSiteTile(out tile, 7, 27, num1 != 0, num2 != 0, nearThisTile2);
        }        
        
        // Does what TileFinder.TryFindNewSiteTile does, except requires flat or small hills.
