...
{
    public class WorkGiver_PutPicklingInPickleCrockBulk : WorkGiver_Scanner
    {
        ...
        private const String PICKLING_STUFF = "RH_TET_CookedPickling";
        ...
        public static void Reset()
        {
            ...
            NoWortTrans = "RH_TET_NoPickling".Translate();
        }
        ...
        {
            var thingCurrent = (Building_PicklingCrockBulk)t;
            var t2 = FindStuff(pawn, thingCurrent);
            return new Job(DefDatabase<JobDef>.GetNamed("RH_TET_Dwarfs_PutPicklingInPickleCrockBulk"), t, t2);
        }

        private Thing FindStuff(Pawn pawn, Building_PicklingCrockBulk buildingCurrent)
        {
