...
namespace TheEndTimes
{
    ...
    public class Building_CuringPot : Building
    {
        ...
        private Material BarFilledMat
        {
            get
            {
                ...
                {
                    this.barFilledCachedMat = SolidColorMaterials.SimpleSolidColorMaterial(Color.Lerp(Building_CuringPot.BarZeroProgressColor, Building_CuringPot.BarFermentedColor, this.Progress), false);
                }
        ...
        public void AddStuff(int count)
        {
            ...
            if (this.Ready)
            {
                Log.Warning("Tried to add meat to a curing pot that is already fully cured.");
                return;
            }
