...
{
    public class JobDriver_TakeDriedCuredMeatFromCuringCabinet : JobDriver
    {
        ...
        protected Building_CuringCabinet BuildingToUse =>
            (Building_CuringCabinet)job.GetTarget(BuildingInd).Thing;
