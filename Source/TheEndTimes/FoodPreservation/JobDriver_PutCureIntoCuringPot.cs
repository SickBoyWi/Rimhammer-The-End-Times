...
{
    public class JobDriver_PutCureIntoCuringPot : JobDriver
    {
        private const TargetIndex BuildingInd = TargetIndex.A;
        private const TargetIndex StuffInd = TargetIndex.B;
        private const int Duration = 200;

        protected Building_CuringPot buildingCurrent => (Building_CuringPot)this.job.GetTarget(BuildingInd).Thing;
