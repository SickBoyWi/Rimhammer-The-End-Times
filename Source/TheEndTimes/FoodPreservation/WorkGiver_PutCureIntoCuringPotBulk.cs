...
{
    public class WorkGiver_PutCureIntoCuringPotBulk : WorkGiver_Scanner
    {
        ...
        {
            var thingCurrent = (Building_CuringPotBulk)t;
            var t2 = FindStuff(pawn, thingCurrent);
            return new Job(DefDatabase<JobDef>.GetNamed("RH_TET_Dwarfs_PutCureIntoCuringPotBulk"), t, t2);
        }

        private Thing FindStuff(Pawn pawn, Building_CuringPotBulk buildingCurrent)
        {
