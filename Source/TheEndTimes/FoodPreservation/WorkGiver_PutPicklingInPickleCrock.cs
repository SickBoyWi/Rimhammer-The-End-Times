...
{
    public class WorkGiver_PutPicklingInPickleCrock : WorkGiver_Scanner
    {
        ...
        {
            var thingCurrent = (Building_PicklingCrock)t;
            var t2 = FindStuff(pawn, thingCurrent);
            return new Job(DefDatabase<JobDef>.GetNamed("RH_TET_Dwarfs_PutPicklingInPickleCrock"), t, t2);
        }

        private Thing FindStuff(Pawn pawn, Building_PicklingCrock buildingCurrent)
        {
