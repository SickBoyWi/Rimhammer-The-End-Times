...
{
    public class JobDriver_TakeCuredMeatFromCuringPot : JobDriver
    {
        ...
        protected Building_CuringPot BuildingToUse =>
            (Building_CuringPot)job.GetTarget(BuildingInd).Thing;
