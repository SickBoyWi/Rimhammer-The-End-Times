...
{
    public class JobDriver_TakeCuredMeatFromCuringPotBulk : JobDriver
    {
        ...
        protected Building_CuringPotBulk BuildingToUse =>
            (Building_CuringPotBulk)job.GetTarget(BuildingInd).Thing;
