...
{
    public class WorkGiver_TakeDriedCuredMeatFromCuringCabinet : WorkGiver_Scanner
    {
        ...
        {
            return new Job(DefDatabase<JobDef>.GetNamed("RH_TET_Dwarfs_TakeDriedCuredMeatFromCuringCabinet"), t);
        }
    }
}
