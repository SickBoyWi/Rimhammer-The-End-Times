...
{
    public class JobDriver_TakePickledFoodFromPicklingCrockBulk : JobDriver
    {
        ...
        protected Building_PicklingCrockBulk BuildingToUse =>
            (Building_PicklingCrockBulk)job.GetTarget(BuildingInd).Thing;
