...
{
    public class WorkGiver_TakeCuredMeatFromCuringPot : WorkGiver_Scanner
    {
        ...
        {
            return new Job(DefDatabase<JobDef>.GetNamed("RH_TET_Dwarfs_TakeCuredMeatFromCuringPot"), t);
        }
    }
}
