...
{
    public class JobDriver_PutPicklingInPickleCrockBulk : JobDriver
    {
        private const TargetIndex BuildingInd = TargetIndex.A;
        private const TargetIndex StuffInd = TargetIndex.B;
        private const int Duration = 200;

        protected Building_PicklingCrockBulk buildingCurrent => (Building_PicklingCrockBulk)this.job.GetTarget(BuildingInd).Thing;
