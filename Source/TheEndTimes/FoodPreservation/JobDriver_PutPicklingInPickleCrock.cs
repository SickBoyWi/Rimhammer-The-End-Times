...
{
    public class JobDriver_PutPicklingInPickleCrock : JobDriver
    {
        private const TargetIndex BuildingInd = TargetIndex.A;
        private const TargetIndex StuffInd = TargetIndex.B;
        private const int Duration = 200;

        protected Building_PicklingCrock buildingCurrent => (Building_PicklingCrock)this.job.GetTarget(BuildingInd).Thing;
