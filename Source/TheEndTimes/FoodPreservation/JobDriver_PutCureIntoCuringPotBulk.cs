...
{
    public class JobDriver_PutCureIntoCuringPotBulk : JobDriver
    {
        private const TargetIndex BuildingInd = TargetIndex.A;
        private const TargetIndex StuffInd = TargetIndex.B;
        private const int Duration = 200;

        protected Building_CuringPotBulk buildingCurrent => (Building_CuringPotBulk)this.job.GetTarget(BuildingInd).Thing;
